        ...
        return (
            <ul>
                {this.state.myMovies.map(myMovie =>
                    <li  key={myMovie.movieTitle}>
                        <h1>Title: {myMovie.movieTitle} </h1>
                        <h2>Overview: {myMovie.movieOverview} </h2>
                        <h2>Vote Count: {myMovie.vote_count} </h2>
                        <img src={"https://image.tmdb.org/t/p/w500"+myMovie.moviePoster} />
                        <MovieTvTrailer movieTitle={myMovie.movieTitle}/>
                        <div className="review">rating: <span className="score">{myMovie.movieScore}</span></div>
                        <MovieTvVoteAction movieTitle={myMovie.movieTitle} movieOverview={myMovie.movieOverview} moviePoster={myMovie.moviePoster} movieScore={myMovie.vote_average} visualMediaType={this.props.visualMediaType}/>
